...
echo "  2. Structural gates are bundled with the preset (gates: true on the"
echo "     solidforge-commands row) - solidforge sessions get them automatically."
echo "     LEGACY selective option (do NOT combine with the preset-row gates):"
echo "     define + run plugins/*.host.js from a cordis session."
