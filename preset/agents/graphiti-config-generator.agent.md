...
Reference: memory-protocol.md for complete memory protocol guidance
...
**Entity Types**: Idea, Reference, Memory, subagent
...
```json
{
  ...
  "shared_entity_types": ["Idea", "Reference", "Memory", "subagent"],
